...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("𝙆𝙞𝙣𝙜 𝙈𝙖𝙧𝙞𝙨𝙚𝙡") && _0x2dfb59[0].includes("𝙆𝙞𝙣𝙜 𝙈𝙖𝙧𝙞𝙨𝙚𝙡") && _0x2dfb59[2].includes("Msg_Id")) {
